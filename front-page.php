...
<?php while ( $the_query->have_posts() ) : $the_query->the_post(); 
          if($count <= 2) { ?>
          <div class="position-absolute circle-md" style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>)">
          </div>
          <?php } else { 
            break; 
          }
...
<?php while ( $the_query->have_posts() ) : $the_query->the_post(); 
          if($count <= 4 && $count > 2) { ?>
          <div class="position-absolute circle-big" style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>)">
          </div>
          <?php } elseif ($count > 4){ 
            break; 
          }
